			...
			<div className={"container mx-auto flex flex-col items-center justify-center p-4"}>
				...
				<div className="grid gap-3 pt-3 mt-3 text-center md:grid-cols-2 lg:w-2/3 w-full">
					<InfoCard name="Místo a příjezd">
						...
						<Link className="link text-primary-focus" href={"https://goo.gl/maps/XKoVBVFvBy1wzemp7"}>
							větší parkoviště je 5 minut chůze.
						</Link>
					</InfoCard>
					<InfoCard name="Ubytování">
						K dispozici budeme mít celý penzion, lůžek však není mnoho a na všechny se bohužel nedostane.
						Přednost budou mít mimopražští hosté a hosté s dětmi. Protože budeme ale v Praze,{" "}
						<Link href={"https://www.liftago.cz/"}>Liftaga</Link> /{" "}
						<Link href={"https://bolt.eu/"}>Bolty</Link> / <Link href={"https://www.uber.com/"}>Ubery</Link>{" "}
						/{" "}
						<Link
							href={
					...
					<InfoCard name="Občerstvení">
						Již od příjezdu hostí bude připraveno občerstvení, na které po obřadě navážeme společným obědem
						a večer plánujeme grilovat. Nápoje potečou proudem až do noci, k dispozici bude plzeň, víno,
						nealko, káva.
					</InfoCard>
					<InfoCard name="Dresscode">
						Svatba je slavnostní událost, proto prosíme, tepláky nechte doma. S formálností to také není
						potřeba přehnat, obřad bude v zahradě.
					</InfoCard>
